...
NIFTY_NEXT50 = [
    ...
    "BAJAJHLDNG.NS","BAJAJHFL.NS","BANKBARODA.NS","BOSCHLTD.NS","BRITANNIA.NS",
...
NIFTY_MIDCAP = [
    ...
    "CANFINHOME.NS","CASTROLIND.NS","CEATLTD.NS","CESC.NS","CGPOWER.NS",
    ...
    "MOTHERSON.NS","MPHASIS.NS","MRF.NS","NATIONALUM.NS","NAVINFLUOR.NS",
    "NBCC.NS","NCC.NS","NLCINDIA.NS","NMDC.NS","OBEROIRLTY.NS",
    "OFSS.NS","OIL.NS","PERSISTENT.NS","PETRONET.NS","PFIZER.NS",
